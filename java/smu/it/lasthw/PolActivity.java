...
public class PolActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_pol);
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(PolActivity.this, MyPageActivity.class);
        ...
        btn_web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/paul.and.paulina"));
                startActivity(i);
            }
        });
        ...
        btn_reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(PolActivity.this, BreadPolActivity.class);
                Bundle extras = new Bundle();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng SEOUL = new LatLng(37.521036, 126.923982);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(SEOUL);
        markerOptions.title("폴앤폴리나");
        markerOptions.snippet("여의도점");
