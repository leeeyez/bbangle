...
public class BreadTartineActivity extends AppCompatActivity {
    int i;
    //dialog 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BreadTartineActivity.this, MyPageActivity.class);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tartine1),
                "Croissant Sandwich", "4500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tartine2),
                "Katsu Sandwich", "13000");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tartine3),
                "Meatball Slab Sandwich", "8500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tartine4),
                "Croissant", "3800");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tartine5),
                "Banana cream tart", "4000");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                dialogView = (View) View.inflate(BreadTartineActivity.this,R.layout.dialog1,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(BreadTartineActivity.this);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(BreadTartineActivity.this, TimeActivity.class);
