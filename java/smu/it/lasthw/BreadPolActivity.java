...
public class BreadPolActivity extends AppCompatActivity {
    int i;
    //dialog 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BreadPolActivity.this, MyPageActivity.class);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pol1),
                "Bbaengo Chocolat", "3500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pol2),
                "Tuna Sandwich", "4800");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pol3),
                "Scone", "2500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pol4),
                "Panettone", "3200");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pol5),
                "Pig Rye Bread", "3000");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                dialogView = (View) View.inflate(BreadPolActivity.this,R.layout.dialog1,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(BreadPolActivity.this);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(BreadPolActivity.this, TimeActivity.class);
