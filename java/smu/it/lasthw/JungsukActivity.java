...
public class JungsukActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_jungsuk);
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(JungsukActivity.this, MyPageActivity.class);
        ...
        btn_web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/standard_of_bread/"));
                startActivity(i);
            }
        });
        ...
        btn_reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(JungsukActivity.this, BreadJungsukActivity.class);
                Bundle extras = new Bundle();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng SEOUL = new LatLng(37.546392, 127.043439);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(SEOUL);
        markerOptions.title("빵의 정석");
        markerOptions.snippet("성수점");
