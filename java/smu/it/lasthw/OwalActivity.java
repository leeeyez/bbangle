...
public class OwalActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_owal);
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(OwalActivity.this, MyPageActivity.class);
        ...
        btn_web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/maybell_bakery/"));
                startActivity(i);
            }
        });
        ...
        btn_reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(OwalActivity.this, BreadOwalActivity.class);
                Bundle extras = new Bundle();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng SEOUL = new LatLng(37.537097, 126.999020);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(SEOUL);
        markerOptions.title("오월의 종");
