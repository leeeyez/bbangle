...
public class BreadJungsukActivity extends AppCompatActivity {
    int i;
    //dialog 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BreadJungsukActivity.this, MyPageActivity.class);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.jungsuk1),
                "Earl Gray Croissant", "3200");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.jungsuk2),
                "Vegetable Ciabatta", "3500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.jungsuk3),
                "Olive Stick", "2800");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.jungsuk4),
                "Sweet Potato Pastry", "3800");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.jungsuk5),
                "Dark Choco Muffins", "3000");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                dialogView = (View) View.inflate(BreadJungsukActivity.this,R.layout.dialog1,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(BreadJungsukActivity.this);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(BreadJungsukActivity.this, TimeActivity.class);
