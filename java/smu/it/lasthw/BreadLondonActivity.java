...
public class BreadLondonActivity extends AppCompatActivity {
    int i;
    //dialog 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BreadLondonActivity.this, MyPageActivity.class);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.london1),
                "Potato cheese bagel", "5500");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.london2),
                "Salt butter bagel", "4700");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.london3),
                "Blueberry bagel", "4700");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.london4),
                "Plain bagel", "3800");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.london5),
                "Dark chocolate bagel", "4900");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                dialogView = (View) View.inflate(BreadLondonActivity.this,R.layout.dialog1,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(BreadLondonActivity.this);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(BreadLondonActivity.this, TimeActivity.class);
