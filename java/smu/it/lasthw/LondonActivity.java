...
public class LondonActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_london);
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(LondonActivity.this, MyPageActivity.class);
        ...
        btn_web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/london.bagel.museum/"));
                startActivity(i);
            }
        });
        ...
        btn_reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(LondonActivity.this, BreadLondonActivity.class);
                Bundle extras = new Bundle();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng SEOUL = new LatLng(37.579185, 126.986161);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(SEOUL);
        markerOptions.title("런던베이글 뮤지엄");
        markerOptions.snippet("안국점");
