...
public class BreadOwalActivity extends AppCompatActivity {
    int i;
    //dialog 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmyPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BreadOwalActivity.this, MyPageActivity.class);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                dialogView = (View) View.inflate(BreadOwalActivity.this,R.layout.dialog1,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(BreadOwalActivity.this);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent i = new Intent(BreadOwalActivity.this, TimeActivity.class);
